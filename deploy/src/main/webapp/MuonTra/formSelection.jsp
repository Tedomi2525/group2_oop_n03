...
<body>
	...
	<div class="container">
		<div class="search-bar">
			<form method="get" action="/deploy/MuonTra/formSelection.jsp">
				<input type="text" name="search" placeholder="Tìm sách theo tên"
					class="search-input"
		...
		<form method="post" action="/deploy/MuonTra/registerBook.jsp">
			<table>
				<tr>
					<th>Chọn</th>
					<th>Mã sách</th>
				...
				try {
					...
					conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/admindb", "root", "Quanopo123+");
